...
const normalizeClient = (client: LegacyClient): Client => {
  const segmentoTags = (
    (client as any).segmentoTags && (client as any).segmentoTags.length > 0
      ? (client as any).segmentoTags
      : client.segment
        ? [client.segment]
        : []
  )
  ...
  const contatoPrincipal = (client as any).contatoPrincipal || {};
  const endereco = (client as any).endereco || (client as any).address || {};

  return {
    id: (client as any).id || generateId(),
    razaoSocial:
      (client as any).razaoSocial ||
      (client as any).nomeFantasia ||
      client.name ||
      "Cliente sem razão social",
    nomeFantasia: (client as any).nomeFantasia || client.tradeName || "",
    ...
    contatoPrincipal: {
      nome:
        ...
        (client as any).primaryContactName ||
        "",
      whatsapp:
    ...
    endereco: {
      cep: endereco.cep || "",
      logradouro: endereco.logradouro || (typeof client.address === "string" ? client.address : "") || "",
      numero: endereco.numero || "",
      complemento: endereco.complemento || "",
      bairro: endereco.bairro || "",
      cidade: endereco.cidade || client.city || "",
      uf: endereco.uf || "",
    },
    ...
    lastContact: (client as any).lastContact || getDate(),
    createdAt: (client as any).createdAt || getDate(),
  };
};
...
const initialClients: Client[] = [
  {
    ...
    observacoesInternas:
      "Cliente estratégico focado em redução de custos e eficiência operacional.",
  ...
  },
  {
    ...
    contatoPrincipal: {
      nome: "Rodrigo Lima",
      whatsapp: "+55 19 97777-2222",
      email: "rodrigo.lima@xyz.com",
    },
    endereco: {
      cep: "13000-000",
  ...
  },
  {
    ...
    contatoPrincipal: {
      nome: "Fernanda Souza",
      whatsapp: "+55 21 96666-3333",
      email: "fernanda@comercio123.com",
    },
    endereco: {
      cep: "20000-000",
  ...
  },
  {
    ...
    contatoPrincipal: {
      nome: "Juliana Castro",
      whatsapp: "+55 31 95555-4444",
      email: "juliana@jklservicos.com",
    },
    endereco: {
      cep: "30000-000",
...
const initialProjects: Project[] = [
  {
    id: "1",
    name: "Otimização de Compras",
    clientId: "1",
    clientName: "ABC Indústrias",
    phase: "Estruturação",
    progress: 75,
    status: "green",
...
const initialTasks: Task[] = [
  {
    id: "1",
    title: "Mapear fornecedores críticos",
    projectId: "1",
    projectName: "Otimização de Compras",
    clientId: "1",
  ...
  {
    id: "3",
    title: "Treinar equipe de compras",
    projectId: "1",
    projectName: "Otimização de Compras",
    clientId: "1",
    clientName: "Empresa ABC",
  ...
  {
    id: "4",
    title: "Configurar dashboard financeiro",
    projectId: "3",
...
const initialMeetings: Meeting[] = [
  {
    ...
    status: "scheduled",
    hasMinutes: false,
    participants: ["Ana Silva", "Cliente"],
    createdAt: "10/12/2024",
  },
  {
    id: "2",
    title: "Review do Diagnóstico",
    projectId: "2",
    projectName: "Gestão de Estoque",
    clientId: "2",
    clientName: "Indústria XYZ",
    ...
    status: "scheduled",
    hasMinutes: false,
    participants: ["Carlos Santos", "Cliente"],
    createdAt: "12/12/2024",
  },
  {
    id: "3",
    ...
    projectId: "4",
    projectName: "Processos de Vendas",
    clientId: "4",
    clientName: "Serviços JKL",
    date: "16/12/2024",
    time: "15:30",
    type: "online",
    status: "completed",
    hasMinutes: true,
    participants: ["João Costa", "Cliente"],
    createdAt: "01/12/2024",
  },
];
...
const initialDiagnostics: Diagnostic[] = [
  {
    ...
    clientName: "Empresa ABC",
    templateId: "1",
    templateName: "Diagnóstico Completo JoIA",
    status: "completed",
    progress: 100,
    score: 68,
    opportunities: 12,
...
const initialIndicators: Indicator[] = [
  {
    ...
    responsible: "Ana Silva",
    values: [
      { date: "01/11/2024", value: 35000 },
      { date: "01/12/2024", value: 42000 },
    ],
    createdAt: "01/10/2024",
  },
  {
    ...
    responsible: "Carlos Santos",
    values: [
      { date: "01/11/2024", value: 4.2 },
      { date: "01/12/2024", value: 4.8 },
    ],
    createdAt: "15/11/2024",
  },
];
...
const initialContentItems: ContentItem[] = [
  {
    id: "1",
    title: "Como reduzir custos de compras em 30 dias",
    type: "Artigo",
    status: "published",
    tags: ["compras", "redução de custos"],
    createdAt: "01/11/2024",
  },
  {
    id: "2",
    title: "Case: Empresa ABC economiza R$ 200k",
    type: "Case",
    status: "review",
    tags: ["case", "resultados"],
    createdAt: "10/12/2024",
  },
  {
    id: "3",
    title: "5 erros em gestão de estoque",
    type: "Post",
    status: "draft",
    tags: ["estoque", "erros comuns"],
    createdAt: "15/12/2024",
  },
];
...
const initialPlaybooks: Playbook[] = [
  {
    id: "1",
    title: "Como rodar o diagnóstico JoIA",
    area: "Diagnóstico",
    description: "Guia completo para aplicação do diagnóstico",
    whenToUse: "No início de todo projeto",
    howToValidate: "Score preenchido e oportunidades identificadas",
    steps: ["Selecionar template", "Agendar com cliente", "Aplicar perguntas", "Gerar relatório"],
    checklist: ["Template selecionado", "Reunião agendada", "Perguntas respondidas"],
    commonErrors: ["Não registrar evidências", "Pular seções"],
    tags: ["diagnóstico", "início"],
...
export function DataProvider({ children }: { children: ReactNode }) {
  ...
  const value: DataContextType = {
    ...
    updateClient: (id, client) =>
      setClients((prev) =>
        prev.map((c) => (c.id === id ? normalizeClient({ ...(c as any), ...(client as any) }) : c))
      ),
    ...
    updateDocument: (id, document) =>
      setDocuments((prev) =>
        prev.map((d) => (d.id === id ? { ...d, ...document, updatedAt: getDate() } : d))
      ),
