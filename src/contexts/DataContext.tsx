...
const initialClients: Client[] = [
  ...
  },
  {
    ...
    endereco: { cep: "13000-000", logradouro: "Avenida das Américas", numero: "500", bairro: "Jardim América", cidade: "Campinas", uf: "SP", complemento: "" },
  ...
  },
  {
    ...
    endereco: { cep: "30000-000", logradouro: "Rua Central", numero: "900", bairro: "Savassi", cidade: "Belo Horizonte", uf: "MG", complemento: "" },
...
export function DataProvider({ children }: { children: ReactNode }) {
  ...
  const value: DataContextType = {
    ...
    addDocument: (document) =>
      setDocuments((prev) => [...prev, { ...document, id: generateId(), createdAt: getDate(), updatedAt: getDate() }]),
