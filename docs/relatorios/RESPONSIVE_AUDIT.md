...
Coleta: baseline-authorized. 2026-08-30T18:43:51.359Z. 37 rotas (inclui redirect / e fallback *).

Ambiente local, Chrome real com backend sintético interceptado; IA desligada. Nenhum acesso/mutação ao banco real. Coleta anterior às correções de UI quando phase=baseline-authorized.
...
| / | FAIL P0/P1 | FAIL P0/P1 | FAIL P0/P1 | FAIL P0/P1 | FAIL P0/P1 | DOM OK¹ | DOM OK¹ | DOM OK¹ | BUTTON Ver agenda; BUTTON Reunião de revisão extraordinária do planejamento financeiro e operacional30/08/2026 às 15:41Reunião; H2 Minhas prioridades; BUTTON Tarefa 1: Validar conciliação e conferir todas as pendências do ciclo extraordinárioUrgenteNão inici; H2 Hoje 1 |
| /meu-dia | FAIL P0/P1 | FAIL P0/P1 | FAIL P0/P1 | FAIL P0/P1 | FAIL P0/P1 | DOM OK¹ | DOM OK¹ | DOM OK¹ | BUTTON Ver agenda; BUTTON Reunião de revisão extraordinária do planejamento financeiro e operacional30/08/2026 às 15:41Reunião; H2 Minhas prioridades; BUTTON Tarefa 1: Validar conciliação e conferir todas as pendências do ciclo extraordinárioUrgenteNão inici; H2 Hoje 1 |
...
| /projetos | DOM OK¹ | DOM OK¹ | DOM OK¹ | DOM OK¹ | FAIL P0/P1 | DOM OK¹ | DOM OK¹ | DOM OK¹ | BUTTON  |
| /projetos/:id | FAIL P0/P1 | FAIL P0/P1 | FAIL P0/P1 | FAIL P0/P1 | FAIL P0/P1 | FAIL P0/P1 | DOM OK¹ | DOM OK¹ | BUTTON Editar; BUTTON Ver Jornada; BUTTON Acompanhar; BUTTON Nova Tarefa |
...
| /templates | FAIL P0/P1 | DOM OK¹ | DOM OK¹ | DOM OK¹ | DOM OK¹ | DOM OK¹ | DOM OK¹ | DOM OK¹ | BUTTON Preview completo |
...
| /templates/:id/preview | FAIL P0/P1 | DOM OK¹ | DOM OK¹ | DOM OK¹ | DOM OK¹ | DOM OK¹ | DOM OK¹ | DOM OK¹ | BUTTON Duplicar |
...
| /reunioes | FAIL P0/P1 | FAIL P0/P1 | DOM OK¹ | FAIL P0/P1 | DOM OK¹ | DOM OK¹ | DOM OK¹ | DOM OK¹ | BUTTON Criar Ata; BUTTON ; BUTTON Nova Reunião; BUTTON Todos os clientes |
...
| * | DOM OK¹ | DOM OK¹ | DOM OK¹ | DOM OK¹ | DOM OK¹ | DOM OK¹ | DOM OK¹ | DOM OK¹ | Estado 404 esperado: a primeira classificação confundia a mensagem de não encontrado com fixture ausente; corrigida pela evidência JSON, sem alterar a coleta |
...
JSON e screenshots: tmp/responsive/baseline-authorized/<viewport>/. Screenshots completos nas larguras 375, 768, 1440.
